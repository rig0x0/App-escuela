...
import { ComboboxDocentes } from "@/app/(dashboard)/materias/combobox-docentes"; // Este es el nuevo componente que creamos
import { ComboboxSemestre } from "@/app/(dashboard)/grupos/inscripciones/[id]/semestres-combobox"; // Reutilizamos el que ya tienes
